...
function map_init() {
    ...
    var point = new BMap.Point(112.999703,28.024279); //地图中心点
    ...
    for (var i = 0; i < markerArr.length; i++) {
        var myIcon = new BMap.Icon('../pully_PC/images/base/address.png', new BMap.Size(22, 35));//这里先不用第三个参数IconOptions
